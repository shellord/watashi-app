    ...
    <div className='bg-white pb-2'>
      <div className='relative flex flex-col items-center'>
        ...
        <div className='absolute top-[3.5rem]'>
          <div className='bg-gray-500 rounded-full w-24 h-24' />
        </div>
        <div className='mt-12 flex flex-col items-center space-y-3'>
          <div className='w-32 h-2 bg-gray-500 animate-pulse' />
          <div className='w-12 h-2 bg-gray-500 animate-pulse' />
          <div className='w-24 h-2 bg-gray-500 animate-pulse' />
        </div>
      </div>
    </div>
  )
